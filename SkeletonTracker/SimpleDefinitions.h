...
const _SMPL_SKELETON_POSITION_INDEX SMPL_INDEX_FROM_KINECT_CHILD[NUI_SKELETON_POSITION_COUNT] = {
	SMPL_SKELETON_POSITION_HIP_CENTER, // should never be chosen 0
	SMPL_SKELETON_POSITION_STOMACH, // lower spine
	SMPL_SKELETON_POSITION_CHEST, // upper spine
	SMPL_SKELETON_POSITION_SHOULDER_CENTER, // neck
	SMPL_SKELETON_POSITION_PECK_LEFT, // left collar
	SMPL_SKELETON_POSITION_SHOULDER_LEFT, // left upper arm
	SMPL_SKELETON_POSITION_ELBOW_LEFT, // left lower arm
	SMPL_SKELETON_POSITION_WRIST_LEFT, // left hand
	SMPL_SKELETON_POSITION_PECK_RIGHT,
	SMPL_SKELETON_POSITION_SHOULDER_RIGHT,
	SMPL_SKELETON_POSITION_ELBOW_RIGHT,
	SMPL_SKELETON_POSITION_WRIST_RIGHT,
	SMPL_SKELETON_POSITION_HIP_CENTER, // *
	SMPL_SKELETON_POSITION_HIP_LEFT, // thigh left
	SMPL_SKELETON_POSITION_KNEE_LEFT,
	SMPL_SKELETON_POSITION_ANKLE_LEFT,
	SMPL_SKELETON_POSITION_HIP_CENTER, // * should be combined
	SMPL_SKELETON_POSITION_HIP_LEFT,
	SMPL_SKELETON_POSITION_KNEE_LEFT,
	SMPL_SKELETON_POSITION_ANKLE_LEFT
};
